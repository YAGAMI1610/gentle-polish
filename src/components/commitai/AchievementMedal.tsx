import chain from "@/assets/badge-chain.png";
import consistency from "@/assets/badge-consistency.png";
import finish from "@/assets/badge-finish.png";
import honesty from "@/assets/badge-honesty.png";
import verified from "@/assets/badge-verified.png";
import { cn } from "@/lib/utils";

export type MedalKind = "honesty" | "verified" | "chain" | "finish" | "consistency";

const ART: Record<MedalKind, string> = { honesty, verified, chain, finish, consistency };
