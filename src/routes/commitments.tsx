...
export const Route = createFileRoute("/commitments")({
  head: () => ({
    meta: [
      ...
      {
        name: "description",
        content: "Lock funds behind a goal. Your principal always comes back — the reward is what's at stake.",
      },
      { property: "og:title", content: "On-chain commitments — CommitAI" },
      { property: "og:description", content: "Clear terms, visible failure path, no punishment." },
    ],
  }),
