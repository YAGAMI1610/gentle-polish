...
export const Route = createFileRoute("/check-in")({
  head: () => ({
    meta: [
      ...
      {
        name: "description",
        content: "Walk through this week's progress with your agent and get an honest verification result.",
      },
      { property: "og:title", content: "Check in — CommitAI" },
      { property: "og:description", content: "Let's make sure this week's progress counts." },
    ],
  }),
  component: CheckIn,
});
        ...
        <CardContent className="py-5">
          ...
          <div className="mt-4 flex flex-wrap gap-2">
            <Button asChild size="sm">
              <Link to="/goals/$goalId" params={{ goalId: "g-read-12" }}>
                See the goal
              </Link>
            </Button>
            <Button asChild size="sm" variant="outline">
              <Link to="/verify">Add supporting evidence</Link>
            </Button>
          </div>
        </CardContent>
      </Card>
