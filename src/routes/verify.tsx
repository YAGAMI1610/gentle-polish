...
export const Route = createFileRoute("/verify")({
  head: () => ({
    meta: [
      ...
      {
        name: "description",
        content: "Share only the evidence you're comfortable with. It stays private; only a hash goes on-chain.",
      },
      { property: "og:title", content: "Submit evidence — CommitAI" },
      { property: "og:description", content: "Private evidence, verifiable result." },
    ],
  }),
